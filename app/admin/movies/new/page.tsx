...
export default function NewMoviePage() {
  ...
  useEffect(() => {
    if (!loading && !user) {
      router.push('/auth/sign-in?redirect=/admin/movies/new')
      return
    }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Create a new movie entry</p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Enter the basic details about the movie
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Add image and video URLs for the movie
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
